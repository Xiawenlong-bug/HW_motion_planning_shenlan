 ...
 * @Date: 2024-08-30 16:14:05
 * @LastEditors: Xiawenlong-bug 2473833028@qq.com
 * @LastEditTime: 2024-08-30 19:51:26
 * @FilePath: /hw4_ws/src/grid_path_searcher/include/hw_tool.h
...
{	
	...
	public:
		...
		double getJ(Eigen::Vector3d _start_position, Eigen::Vector3d _start_velocity, Eigen::Vector3d _target_position, double T);
};
