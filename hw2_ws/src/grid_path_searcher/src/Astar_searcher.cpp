...
double AstarPathFinder::getHeu(GridNodePtr node1, GridNodePtr node2)
{
   ...
   //Euclidean
    ...
    // int dy = node2->index[1]-node2->index[1];
    // int dz = node2->index[2]-node2->index[2];
    int dx=node1->coord(0)-node2->coord(0);
    int dy=node1->coord(1)-node2->coord(1);
    int dz=node1->coord(2)-node2->coord(2);
    // ROS_INFO("2222222222222222222222222222222222222222222222222222");
    ...
    while ( !openSet.empty() ){
        ...
        */
        ...
        if( currentPtr->index == goalIdx ){
            // ROS_INFO("GGGGGGOOOOOOAAAAAALLLLLLLLLLLLLLLLL_GET");
        ...
        for(int i = 0; i < (int)neighborPtrSets.size(); i++){
            ...
            */
            ...
            { // discover a new node, which is not in the closed set and open set
                ...
                *        
                */
                // double tem_gScore = edgeCostSets[i];
                // if(tem_gScore < neighborPtr->gScore){
                //     neighborPtr->cameFrom = currentPtr;
                //     neighborPtr->gScore = tem_gScore;
                //     neighborPtr->fScore = neighborPtr->gScore + getHeu(neighborPtr, endPtr);
                // }
                // continue;
...
//     //    gridPath.push_back(GridNodeMap[x][y][z]);
//     gridPath.push_back(terminatePtr);
//     terminatePtr = terminatePtr->cameFrom;
//     // ROS_INFO("FINDING WAYS");
//     // ROS_INFO("gggggggggggggggggggggggggggggggggg...");
//    }
